...
const MAPTILER_TILE_URL = "https://api.maptiler.com/maps/019fe1fa-e820-78cd-bccf-a2a78e5f39b3/256/{z}/{x}/{y}.png?key=| \"Cloudy\";";
...
function renderDots(fallbackWeather, areaCities, token) {
  ...
  dots.innerHTML = areaCities
    .map(function (city) {
      ...
      const condition = cityWeather.condition || cityWeather.cond |      const isDaytime = cityWeather.isDaytime ?? true;
